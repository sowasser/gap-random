...
9.  When you are done with your session, make sure to turn off the instance by pressing 'STOP' in the menu bar. The connection to the command line and Rstudio will be terminated and the status icon will return to the gray square. This is **very** important for keeping operating costs reasonable.
...
1.  Once you have connected to your instance through step 8 above, open your browser and navigate to `http://localhost:8787/`
